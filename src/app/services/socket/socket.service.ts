...
export class SocketService {
  ...
  public subscribeToChannel(channel: string): void {
    console.log('Voce se increvel no canal room_98522b7d-81d9-4c71-9ef4-fe505aae92b6')
    this.sendMessage("subscribe", "room_98522b7d-81d9-4c71-9ef4-fe505aae92b6", "mensagem");
  }
